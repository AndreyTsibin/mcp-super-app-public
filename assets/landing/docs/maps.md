...
> Не хочешь iframe — сделай скриншот карты, положи в `src/assets/img/`, импортируй
> в data-файл и передай `mapImage` с `variant="screenshot"`: он легче и не тянет чужой JS.
