...
**Recommended model:** `google/gemini-3.1-flash-image` — the pattern lives on micro-texture (fracture grain, sifted cocoa dust, temper shine); flash resolves it up close where seedream goes slightly waxy.
