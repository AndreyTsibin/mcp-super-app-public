...
каждую сессию, бюджет ~12 000 символов, на английском). Детальная дока живёт в \`docs/\` и
...
**Бюджеты контекста** — в символах, не в строках и не в токенах: \`CLAUDE.md\` ≤12 000
(≈4k токенов) · HANDOFF ≤3 000, один экран · трекер ≤12 000 · \`.claude/rules/*\` ≤4 000 ·
любой другой документ ≤24 000. Считает \`node .claude/scripts/check-docs.mjs\`; точную
цифру в токенах даёт только \`/context\` в интерактивном терминале.
