...
export const SKILLS: readonly SkillDef[] = [
  ...
  },
  {
    ...
    description:
      "Writes model-specific image prompts for Gemini 3.1 Flash / Flash Lite / 3 Pro and Seedream 5.0 Lite / Pro, plus the sizing args to pass — feed the result to create_image. Prompt syntax follows each vendor's official guide. Parts derive from smixs/visual-skills (MIT).",
    ignore: [CLAUDE_SKILLS],
  },
  {
    id: "remove-ai-marks",
